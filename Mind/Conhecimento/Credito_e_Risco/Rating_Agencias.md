...
Indica baixa probabilidade de default e alta capacidade de pagamento.
- **S&P/Fitch**: AAA, AA, A, BBB
- **Moody's**: Aaa, Aa, A, Baa

### Speculative Grade (Grau Especulativo)
Indica maior vulnerabilidade a condições adversas e maior risco de crédito.
- **S&P/Fitch**: BB, B, CCC, CC, C, D (Default)
...
4. **Critérios de Elegibilidade**: Regras para entrada de novos direitos creditórios no fundo.

#credito #rating #fidc #investimento #risco
