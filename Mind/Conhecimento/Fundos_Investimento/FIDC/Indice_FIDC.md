...
Este índice organiza o aprendizado sobre [[FIDC_Conceitos|FIDC]] em uma sequência que conecta estrutura, operação, risco, contabilidade e jurídico aplicado.

## Comece aqui
- [[Como_Funciona_um_FIDC|Como Funciona um FIDC]]
- [[FIDC_Conceitos|FIDC - Conceitos]]
- [[Participantes_de_um_FIDC|Participantes de um FIDC]]
- [[Papeis_e_Responsabilidades_na_Estrutura_do_FIDC|Papéis e Responsabilidades na Estrutura do FIDC]]
- [[Tipos_de_Cotas_em_FIDC|Tipos de Cotas em FIDC]]
- [[Ciclo_de_Vida_de_uma_Operacao_de_FIDC|Ciclo de Vida de uma Operação de FIDC]]

## Estrutura e operação
- [[Criterios_de_Elegibilidade|Critérios de Elegibilidade]]
- [[Waterfall_e_Ordem_de_Pagamentos|Waterfall e Ordem de Pagamentos]]
- [[Gatilhos_e_Eventos_de_Avaliacao|Gatilhos e Eventos de Avaliação]]
- [[Estruturacao_e_Operacoes/Fluxo_Operacional_de_Aquisicao_de_Direitos_Creditorios|Fluxo Operacional de Aquisição de Direitos Creditórios]]
- [[Estruturacao_e_Operacoes/Cessao_de_Credito|Cessão de Crédito]]
- [[Estruturacao_e_Operacoes/Coobrigacao_e_Recompra|Coobrigação e Recompra]]
- [[Estruturacao_e_Operacoes/Servicing_e_Custodia|Servicing e Custódia]]
...
- [[Duration_de_Recebiveis_em_FIDC|Duration de Recebíveis em FIDC]]
...
- [[FIDC_Multicedente_Multissacado|FIDC Multicedente e Multissacado]]
- [[FIDC_Cartao|FIDC de Recebíveis de Cartão]]
- [[FIDC_Consignado|FIDC de Consignado]]
- [[FIDC_Agro|FIDC Agro]]
- [[FIDC_NPL|FIDC NPL]]
- [[Securitizacao_de_Recebiveis_Avancada|Securitização de Recebíveis Avançada]]

## Jurídico aplicado
- [[Juridico_e_Regulatorio/True_Sale_em_FIDC|True Sale em FIDC]]
- [[Juridico_e_Regulatorio/Patrimonio_Segregado_e_Risco_de_Originador|Patrimônio Segregado e Risco de Originador]]
- [[Juridico_e_Regulatorio/Conflitos_de_Interesse_em_FIDC|Conflitos de Interesse em FIDC]]
...
- [[Contabilidade_e_Controle/Indice_Contabilidade|Contabilidade e Controle]]
...
#fidc #recebiveis #credito #fundos #estrutura
