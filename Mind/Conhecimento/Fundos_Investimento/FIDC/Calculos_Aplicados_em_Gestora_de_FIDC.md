# Cálculos Aplicados em Gestora de FIDC
...
- [[TIR_e_XIRR_em_FIDC|TIR e XIRR]]
- [[Duration_de_Recebiveis_em_FIDC|duration de recebíveis]]

## Uso gerencial
Os cálculos servem tanto para fechamento quanto para monitoramento de risco, comparação com meta de retorno e leitura da proteção de cada classe de cota.
...
#fidc #calculos #gestora #precificacao #monitoramento
